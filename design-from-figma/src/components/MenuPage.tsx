...
import { mockRestaurants, Dish } from '../data/mockData';
...
export function MenuPage() {
  ...
  const allDishes: Dish[] = restaurant.menuCategories.flatMap(cat => cat.dishes);
